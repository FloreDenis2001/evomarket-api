...
class UserCommandServiceImplTest {
    ...
    @Test
    void addUser() {
        UserDTO userDTO = UserDTO.builder().firstName("Denis").lastName("Flore").email("denisupdate@yahoo.com").password("denis1234").phoneNumber("0722222222").active(true).build();
    ...
    void updateUser() {
        ...
        UserDTO userDTO = UserDTO.builder().firstName("Denis").lastName("Flore").email("denis@yahoo.com").password("denis1234").phoneNumber("0722222222").active(true).build();
        UserDTO userDTO2 = UserDTO.builder().firstName("Denis").lastName("Flore").email("denis@yahoo.com").password("denisupdate1234").phoneNumber("0711111111").active(true).build();
